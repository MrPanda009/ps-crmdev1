  ...
  useEffect(() => {
    ...
    (async () => {
      const { data, error } = await supabase
        .from("complaints")
        .select("id, ticket_id, location, severity, effective_severity, sla_breached, assigned_department, title, description, status, created_at, ward_name, escalation_level");
